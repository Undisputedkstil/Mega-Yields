...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Astonishing Web Design creates custom, visually appealing websites for businesses and individuals." },
      { property: "og:description", content: "Astonishing Web Design creates custom, visually appealing websites for businesses and individuals." },
      { name: "twitter:description", content: "Astonishing Web Design creates custom, visually appealing websites for businesses and individuals." },
